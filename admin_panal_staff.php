				...
				<div class="card">
					...
					<div class="card-body">
					 <form class="form-group" action="func.php" method="post">
						...
						<label>Address : </label>
						<textarea rows="3" class="form-control" id="exampleTextarea" name="address"></textarea><br>
						<label>Contact : </label>
						...
						<input type="submit" class="btn btn-primary" name="staff_submit" value="Enter Appointment">
					 </form>
					</div>
				</div>
			</div>
